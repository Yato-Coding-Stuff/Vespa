...
impl Config {
    ...
    pub fn set_default_profile(
        ...
        match game {
            ...
            GameSwitcher::SilkSong => self.default_profile = Some(profile),
        }
        self.save()?;
        Ok(())
    }
    ...
    pub fn clear_default_profile(&mut self, game: &GameSwitcher) -> Result<(), ConfigError> {
        match game {
            ...
            GameSwitcher::SilkSong => self.default_profile = None,
        }
        self.save()?;
        Ok(())
    }
    ...
    pub fn get_default_profile(&self, game: &GameSwitcher) -> Option<String> {
        match game {
            ...
            GameSwitcher::SilkSong => self.default_profile.clone(),
        }
    }
...
mod tests {
    ...
    fn sample_config() -> Config {
        Config {
            game_switcher: GameSwitcher::SilkSong,
            default_profile: Some("sk-default".to_string()),
